...
export default function PersonScreen() {
    ...
    return (
    <ScrollView className="flex-1 bg-slate-950" showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 20}}>
        <SafeAreaView className=" z-20 w-full flex-row justify-between items-center px-4 mt-2 mx-2 ">
            <TouchableOpacity 
            onPress={()=> navigation.goBack()}
            className={"rounded-xl p-1 bg-orange-400 items-center justify-center"+verticalMargin}>
                <ChevronLeftIcon  size={28} strokeWidth={2.5} color='white'/>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=> toggleFavorite(!isFavorite)} className="mr-3">
    ...
    <View>
        ...
        shadowRadius: 40,
    shadowOffset: {width: 0, height: 5}, shadowOpacity: 1}}
        ...
        <View className="mx-2 mt-6 p-4 flex-row justify-center items-center bg-neutral-700 rounded-full">
